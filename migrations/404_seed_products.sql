...
-- Ürünleri kategori ve tiplerine göre ekle
...
-- Güller (type_id:1 - Tek Çiçek, category_id:2 - Güller)
...
-- Mevsimlikler (type_id:1 - Tek Çiçek, category_id:4 - Mevsimlikler) 
...
-- Orkideler (type_id:1 - Tek Çiçek, category_id:3 - Orkideler)
...
-- Buketler (type_id:2 - Buket, category_id:6 - Buketler)
...
-- Saksı Çiçekleri (type_id:4 - Saksı, category_id:9/10 - Saksı kategorileri)
...
-- Malzemeler (type_id:5 - Malzeme, category_id:12/13/14 - Malzeme kategorileri)
